...
class ProduitServices{
  ...
  static Future<ModelProduit> ajoutProduit(String nom, String description,
      String marque, Long prix,String model,String capacite, String image,
      Long quantite_disponible, String type,String categorie,String boutiques, String user) async {
    Map data = {
      'nom': nom,
